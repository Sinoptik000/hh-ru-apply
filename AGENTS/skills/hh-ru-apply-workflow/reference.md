...
Из [README.md](../../../README.md): опционально в `.env` задают `COVER_LETTER_STYLE_MAX_CHARS` (по умолчанию 5000), `COVER_LETTER_STYLE_QUEUE_ITEMS` (по умолчанию 4). Ручные эталоны — `config/cover-letter-style-examples.txt`.
