...
- `config/cover-letter-ops.txt` — шаблон для вакансий операционного, административного и проектного профиля.
- `config/cover-letter-sales.txt` — шаблон для вакансий в продажах и работе с партнёрами.

Отредактируйте нужный файл под вашу манеру, опыт и ключевые формулировки. При необходимости можно скопировать структуру и тексты из одного шаблона в другой.

Для сохранения вашего стиля в письмах положите примеры в `config/cover-letter-style-examples.txt` (несколько писем, разделённых `---`).
